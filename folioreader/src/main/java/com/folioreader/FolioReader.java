...
public class FolioReader {
    ...
    public FolioReader openBook(String assetOrSdcardPath,String bookName) {
        Intent intent = getIntentFromUrl(assetOrSdcardPath,bookName, 0);
        context.startActivity(intent);
        return singleton;
    }

    public FolioReader openBook(int rawId,String bookName) {
        Intent intent = getIntentFromUrl(null,bookName, rawId);
        context.startActivity(intent);
        return singleton;
    }

    public FolioReader openBook(String assetOrSdcardPath, String bookId,String bookName) {
        Intent intent = getIntentFromUrl(assetOrSdcardPath,bookName, 0);
    ...
    public FolioReader openBook(int rawId, String bookId,String bookName) {
        Intent intent = getIntentFromUrl(null,bookName, rawId);
        intent.putExtra(EXTRA_BOOK_ID, bookId);
        context.startActivity(intent);
        return singleton;
    ...
    private Intent getIntentFromUrl(String assetOrSdcardPath,String bookName, int rawId) {
        ...
        intent.putExtra(FolioActivity.BOOK_NAME, bookName);
        return intent;
    }
